...
map.getView().fit([12280757.177816, -875911.982872, 12293213.834997, -866794.097858], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">yogya</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (18 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'hai ini peta yogya';
            }
